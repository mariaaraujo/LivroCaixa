    ...
    <table style="margin: auto;">
        <tr>
            <td>
                ...
                <asp:TextBox ID="txt_Descricao" runat="server" Width="244px" />
            </td>
            <td>
                <asp:Label ID="lbl_Valor" runat="server" Text="Valor" />
                <asp:TextBox ID="txt_Valor" runat="server" width="8em" />
            </td>
            ...
            <td style="text-align: center;">
                ...
                <asp:Label ID="lbl_Credito" runat="server" Text="Credito" />
            ...
            <td>
                ...
                <asp:TextBox ID="txt_Data" runat="server" width="12em" />
            </td>
            <td>
